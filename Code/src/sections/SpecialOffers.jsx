    ...
    gap-10 max-container">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className='mt-4 lg:max-w-lg info-text'>
          ...
          deals. From premier selections to increadible savings, we offer unparalleled 
          value that sets us apart.
        </p>
        <p className='mt-6 lg:max-w-lg info-text'>
          Navigate a realm of possibilities designed to fulfill your unique desires, 
          surpassing the loftties expextations. Your journey with us is nothing short of
          exceptional.
        </p>
